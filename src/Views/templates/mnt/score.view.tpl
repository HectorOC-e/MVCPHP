...
<section>
  <form action="index.php?page=mnt_score" method="post">
    ...
    <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="scoredsc" name="scoredsc" placeholder="Descripcion" value="{{scoredsc}}"/>
      {{if error_scoredsc}}
    ...
    <fieldset>
      <label for="scoresales">Vendidos</label>
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="scoresales" name="scoresales" placeholder="Vendidos" value="{{scoresales}}" />
      {{if error_scoresales}}
